...
~~Не вижу смысла копипастить.~~ Кое-что он не упомянул, а именно работу с регистрами `r8, ..., r15`: это обычные регистры, появившиеся с архитектурой x86_64. Они 64бит, но тоже позволяют обращаться к своим частям:
